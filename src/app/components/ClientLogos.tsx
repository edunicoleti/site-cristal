...
const clients = [
  ...
  { name: "Agropecuária Seis Irmãos", logo: "/logo clientes/seis irmaos.jpeg", customClass: "mix-blend-multiply !h-[48px] md:!h-[64px] !max-w-[200px]" },
  ...
  { name: "Agromina", logo: "/logo clientes/agromina correta.jfif", customClass: "mix-blend-multiply !h-[48px] md:!h-[60px] !max-w-[200px]" },
